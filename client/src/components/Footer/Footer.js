            ...
            <footer className="page-footer" id="Footer">
                <div className="container">
                    <div className="row">
                        ...
                        <a href="https://drive.google.com/file/d/1P-DD7jdtgIAvZwrBgHk7tssLmGv4QSCw/view" target="_blank"><i id="FAIcon" className="center fa fa-2x waves-effect waves-light"></i></a>
                        </div>
                        </div>
                    </div> 
