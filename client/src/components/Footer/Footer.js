            ...
            <footer className="page-footer" id="Footer">
                <div className="container">
                    <div className="row">
                        ...
                        <a href="https://github.com/kyleoliveri/KylePortfolio/blob/master/client/src/assets/resume/KyleOliveri_Dev2021_Rev3%20(1).pdf" target="_blank"><i id="FAIcon" className="center fa fa-2x waves-effect waves-light"></i></a>
                        </div>
                        </div>
                    </div> 
